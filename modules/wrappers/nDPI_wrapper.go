...
// #cgo CFLAGS: -I/Users/alien/go/src/go.universe.tf/netboot/third_party/ipxe/src/arch/x86/include -I/usr/local/include/ -I/usr/local/opt/libpcap/include
// #cgo LDFLAGS: -lndpi -lpcap -lm -pthread -L/usr/local/opt/libpcap/lib -L/usr/local/Cellar/liblinear/2.30/lib -L/usr/lib -L/usr/local/lib -L${SRCDIR} -lprotoident -ltrace
